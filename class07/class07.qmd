...
##Background Today we will begin our exploration of some important machine learning methods, namely **clustering** and **dimensionality reduction**
...
The main function in "base R" for K-means clustering is called `kmenas()`:
...
> Q. What component of the results object details the cluster membership vector (i.e. our main results of which points lie in which cluster)?
...
> Q. Run `kmeans()` and this time produce 4 clusters (and call your result object `k4`) and make a results figure like above.
...
The main PCA function in "base R" is called `prcmomp()`. This function wants the tarspose of our food ata as input( i.e. the foods as columns and the countries as rows). 
...
The second major result figure is called "loadings plot" of "variable contributions plot" or "weight plot". 
